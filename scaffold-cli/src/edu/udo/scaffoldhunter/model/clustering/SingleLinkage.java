...
/**
 * The Single Linkage which agglomerates the clusters with the minimum distance
 * between the nearest two elements
 * 
 * @author Till Schäfer
 * @param <S>
 ...
 * 
 */
public class SingleLinkage<S extends Structure> extends Linkage<S> {
     ...
     */
    public SingleLinkage(Collection<PropertyDefinition> propertyVector) {
    ...
    public boolean centreBasedLinkage() {
        return Linkages.SINGLE_LINKAGE.centreBasedLinkage();
    }
    ...
    public boolean needsProstProcessing() {
        return Linkages.SINGLE_LINKAGE.needsProstProcessing();
    }

    /* (non-Javadoc)
     * @see edu.udo.scaffoldhunter.model.clustering.Linkage#doContentMerge(edu.udo.scaffoldhunter.model.db.Structure, edu.udo.scaffoldhunter.model.db.Structure, int, int)
     */
    @Override
    ...
    public boolean isMetric() {
        return Linkages.SINGLE_LINKAGE.isMetric();
    }
    ...
    public boolean fulfilReducibility() {
        return Linkages.SINGLE_LINKAGE.fulfilReproducibility();
    }
