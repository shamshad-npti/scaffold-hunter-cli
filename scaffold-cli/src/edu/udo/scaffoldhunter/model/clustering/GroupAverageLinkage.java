...
/**
 * The Group Average Linkage which agglomerates the clusters with the minimum
 * distance between the average distance between all elements
 * 
 * @author Till Schäfer
 * 
 * @param <S>
 ...
 * 
 */
public class GroupAverageLinkage<S extends Structure> extends Linkage<S> {
     ...
     */
    public GroupAverageLinkage(Collection<PropertyDefinition> propertyVector) {
    ...
    public LanceWilliamsUpdateFormula getUpdateFormula() {
        return new LanceWilliamsUpdateFormula() {
            ...
            public double newDistance(double ki, double kj, double ij, int k, int i, int j) {
                double ai = i / (double) (i + j);
                double aj = j / (double) (i + j);
                return ai * ki + aj * kj;
            }
        };
    }
    ...
    public boolean centreBasedLinkage() {
        return Linkages.GROUP_AVERAGE_LINKAGE.centreBasedLinkage();
    }
    ...
    public boolean needsProstProcessing() {
        return Linkages.GROUP_AVERAGE_LINKAGE.needsProstProcessing();
    }
    ...
    public boolean isMetric() {
        return Linkages.GROUP_AVERAGE_LINKAGE.isMetric();
    }
    ...
    public boolean fulfilReducibility() {
        return Linkages.GROUP_AVERAGE_LINKAGE.fulfilReproducibility();
    }
