...
package edu.udo.scaffoldhunter.plugins.dataimport.impl.example3;
...
public class Example3ImportPlugin extends AbstractImportPlugin {
    ...
    @Override
    public String getID() {
        return "Example3ImportPlugin_v1";
    }
    ...
    public String getDescription() {
        return "The third example in the manual";
    }
    ...
    public PluginSettingsPanel getSettingsPanel(Serializable settings, Object arguments) {
        return new Example3ImportPluginSettingsPanel((Example3ImportPluginArguments) arguments);
    }
    ...
    public PluginResults getResults(Object arguments) {
        return new Example3ImportPluginResults((Example3ImportPluginArguments) arguments);
    }
    ...
    public String checkArguments(Object arguments) {
        Example3ImportPluginArguments args = (Example3ImportPluginArguments) arguments;
