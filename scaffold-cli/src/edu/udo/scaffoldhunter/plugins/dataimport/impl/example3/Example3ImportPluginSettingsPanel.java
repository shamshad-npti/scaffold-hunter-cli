 ...
 * 
 */
public class Example3ImportPluginSettingsPanel extends PluginSettingsPanel {
     ...
     * 
     */
    public Example3ImportPluginSettingsPanel(Example3ImportPluginArguments arguments) {
        // Check if we get Arguments, otherwise fill with default values
        if (arguments == null) {
            arguments = new Example3ImportPluginArguments();
    ...
    public Object getArguments() {
        Example3ImportPluginArguments arguments = new Example3ImportPluginArguments();
