 ...
 * 
 */
public class Example3ImportPluginResults implements PluginResults {

    private Example3ImportPluginArguments arguments;

    /**
     * @param arguments
     * 
     */
    public Example3ImportPluginResults(Example3ImportPluginArguments arguments) {
