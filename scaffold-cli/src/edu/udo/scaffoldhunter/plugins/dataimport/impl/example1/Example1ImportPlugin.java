...
package edu.udo.scaffoldhunter.plugins.dataimport.impl.example1;
...
public class Example1ImportPlugin extends AbstractImportPlugin {
    ...
    @Override
    public String getID() {
        return "Example1ImportPlugin_v1";
    }
    ...
    public String getDescription() {
        return "The first example in the manual";
    }
    ...
    public String checkArguments(Object arguments) {
        return "Example 1 never gives results";
    }
