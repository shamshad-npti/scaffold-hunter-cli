 ...
 *
 */
public class DaylightBitCalcPluginTransformFunction implements Function<IAtomContainer, IAtomContainer> {
    private static Logger logger = LoggerFactory.getLogger(DaylightBitCalcPluginTransformFunction.class);
     ...
     */
    public DaylightBitCalcPluginTransformFunction(DaylightBitCalcPluginArguments args, PropertyDefinition propDef, MessageListener msgListener) {
    ...
    public IAtomContainer apply(IAtomContainer molecule) {
        ...
        try {
            ...
            string = CalcHelpers.Bitset2BitFingerprint(bitset, (short) fingerprinter.getSize());
