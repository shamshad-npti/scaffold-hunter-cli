...
public class Example5CalcPlugin extends AbstractCalcPlugin {
    ...
    public PluginSettingsPanel getSettingsPanel(Serializable settings, Object arguments) {
        if(arguments == null) {
            arguments = new Example5CalcPluginArguments();
        }
        
        return new Example5CalcPluginSettingsPanel((Example5CalcPluginArguments) arguments, availableProperties);
    }
     ...
     */
    @Override
    public CalcPluginResults getResults(final Object arguments, final Iterable<IAtomContainer> molecules, final MessageListener msgListener) {
        final Example5CalcPluginArguments args = (Example5CalcPluginArguments)arguments;
        ...
        return new CalcPluginResults() {
            ...
            public Iterable<IAtomContainer> getMolecules() {
                return Iterables.transform(molecules, new Example5CalcPluginTransformFunction(args, propDef, msgListener));
            }
