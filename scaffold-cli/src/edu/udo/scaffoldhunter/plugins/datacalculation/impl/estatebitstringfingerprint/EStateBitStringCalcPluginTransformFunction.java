 ...
 * 
 */
public class EStateBitStringCalcPluginTransformFunction implements Function<IAtomContainer, IAtomContainer> {
    private static Logger logger = LoggerFactory.getLogger(EStateBitStringCalcPluginTransformFunction.class);
     ...
     */
    public EStateBitStringCalcPluginTransformFunction(PropertyDefinition propDef, MessageListener msgListener) {
    ...
    public IAtomContainer apply(IAtomContainer molecule) {
        ...
        try {
            ...
            string = CalcHelpers.Bitset2BitString(bitset, 79);
