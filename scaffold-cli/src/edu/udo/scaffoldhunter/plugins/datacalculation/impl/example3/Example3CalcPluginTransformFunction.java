 ...
 *
 */
public class Example3CalcPluginTransformFunction implements Function<IAtomContainer, IAtomContainer> {
    
    private Example3CalcPluginArguments arguments;
    private PropertyDefinition propDef;
    
    Example3CalcPluginTransformFunction(Example3CalcPluginArguments arguments, PropertyDefinition propDef) {
