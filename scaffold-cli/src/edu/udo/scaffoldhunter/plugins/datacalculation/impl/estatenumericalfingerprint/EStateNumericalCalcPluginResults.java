 ...
 *
 */
public class EStateNumericalCalcPluginResults implements CalcPluginResults {
     ...
     */
    public EStateNumericalCalcPluginResults(Iterable<IAtomContainer> molecules, MessageListener msgListener) {
        this.molecules = molecules;
        this.msgListener = msgListener;
        propDef = new PropertyDefinition();
        propDef.setKey("EStateNumericalFingerprint");
        propDef.setTitle("EStateNumericalFingerprint");
        propDef.setDescription("A fragment count descriptor with 79 values that uses e-state fragments.");
        propDef.setScaffoldProperty(false);
        propDef.setPropertyType(PropertyType.NumericalFingerprint);
    }
    ...
    public Iterable<IAtomContainer> getMolecules() {
        return Iterables.transform(molecules, new EStateNumericalCalcPluginTransformFunction(propDef, msgListener));
    }
