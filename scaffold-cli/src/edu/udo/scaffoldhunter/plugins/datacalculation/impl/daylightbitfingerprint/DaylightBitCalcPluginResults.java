 ...
 *
 */
public class DaylightBitCalcPluginResults implements CalcPluginResults {
     ...
     */
    public DaylightBitCalcPluginResults(Iterable<IAtomContainer> molecules, DaylightBitCalcPluginArguments arguments, MessageListener msgListener) {
        this.arguments = arguments;
        this.molecules = molecules;
        this.msgListener = msgListener;
        propDef = new PropertyDefinition();
        propDef.setKey("DaylightBitFingerprint");
        propDef.setTitle("DaylightBitFingerprint");
    ...
    public Iterable<IAtomContainer> getMolecules() {
        return Iterables.transform(molecules, new DaylightBitCalcPluginTransformFunction(arguments, propDef, msgListener));
    }
