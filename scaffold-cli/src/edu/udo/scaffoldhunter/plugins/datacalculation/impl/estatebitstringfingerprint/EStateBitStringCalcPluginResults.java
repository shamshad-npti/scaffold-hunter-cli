 ...
 *
 */
public class EStateBitStringCalcPluginResults implements CalcPluginResults {
     ...
     */
    public EStateBitStringCalcPluginResults(Iterable<IAtomContainer> molecules, MessageListener msgListener) {
        this.molecules = molecules;
        this.msgListener = msgListener;
        propDef = new PropertyDefinition();
        propDef.setKey("EStateBitStringFingerprint");
        propDef.setTitle("EStateBitStringFingerprint");
    ...
    public Iterable<IAtomContainer> getMolecules() {
        return Iterables.transform(molecules, new EStateBitStringCalcPluginTransformFunction(propDef, msgListener));
    }
