 ...
 *
 */
public class Example4CalcPluginSettingsPanel extends PluginSettingsPanel {
    
    private Example4CalcPluginArguments arguments;
    private JCheckBox checkbox;
    private JList list;
    
    Example4CalcPluginSettingsPanel(final Example4CalcPluginArguments arguments, Set<PropertyDefinition> availableProperties) {
    ...
    /* (non-Javadoc)
     * @see edu.udo.scaffoldhunter.plugins.dataimport.PluginSettingsPanel#getSettings()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see edu.udo.scaffoldhunter.plugins.dataimport.PluginSettingsPanel#getArguments()
     */
    @Override
