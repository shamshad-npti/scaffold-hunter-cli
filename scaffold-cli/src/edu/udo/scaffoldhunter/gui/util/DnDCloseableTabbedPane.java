/*
 *  based on http://java-swing-tips.blogspot.com/2008/04/drag-and-drop-tabs-in-jtabbedpane.html
 * 
 *  Modifications for Scaffold Hunter:
 *    - renamed to DnDCloseableTabbedPane, deriving from CloseableTabbedPane
 *    - added DnDListener interface 
 */
...
public class DnDCloseableTabbedPane extends CloseableTabbedPane {
    ...
    public DnDCloseableTabbedPane() {
        ...
        final Transferable t = new Transferable() {
            ...
            @Override public Object getTransferData(DataFlavor flavor) {
                return DnDCloseableTabbedPane.this;
            }
    ...
    private int getTargetTabIndex(Point glassPt) {
        Point tabPt = SwingUtilities.convertPoint(glassPane, glassPt, DnDCloseableTabbedPane.this);
    ...
    private void convertTab(int prev, int next) {
        ...
        // XXX
        listener.dndFinished(prev, tgtindex);
    }
